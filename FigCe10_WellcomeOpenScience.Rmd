...
tracks <- structure(c(
  "http://jadb.gurdon.private.cam.ac.uk/db4/files/REPLICATES/H3K36me3/REP054/H3K36me3_N2_L3_NORM_zscore_1bp_PK006^PK007_Fdf07466^Fcf07468.bw", 
...
), .Names = c("REP054", "REP032", "REP055"))
dir.create('tracks_rep')
sapply(tracks, function(x) download.file(x, file.path('tracks_rep', basename(x))) )
